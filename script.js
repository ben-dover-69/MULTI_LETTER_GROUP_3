...
// OPEN ENVELOPE WITH FLAP ANIMATION
openBtn.onclick = () => {
...
sendBtn.onclick = () => {
  ...
  emailjs.send("service_blwhkvs", "template_ka72mdg", payload, "WodD_TueS-UN6i-Va")
    .then((response) => {
    ...
    .catch((err) => {
      ...
      alert("Error sending letter. See console for details.");
    });
};