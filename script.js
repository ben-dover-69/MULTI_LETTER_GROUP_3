document.addEventListener("DOMContentLoaded", () => {
  ...
  // =========================
  // ====== FIX: Ensure long text wraps in editable boxes =====
  document.querySelectorAll(".letter .body.editable-box").forEach(el => {
  ...
  // =========================
  // SEND LETTER – DYNAMIC VIEW LINK FIX
  // =========================
  sendBtn.onclick = () => {
    ...
    const templateParams = {
      ...
      view_link: viewLink // <-- this ensures the button opens the correct letter
    };
