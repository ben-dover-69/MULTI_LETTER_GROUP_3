document.addEventListener("DOMContentLoaded", () => {
  ...
  // =========================
  // SEND LETTER – FIX RECEIVER/SENDER & DYNAMIC VIEW LINK
  // =========================
  sendBtn.onclick = () => {
    ...
    // Get content (FIX: works for all letters)
    const receiverEl = activeLetter.querySelector(".dear .editable-box");
    const senderEl = activeLetter.querySelector(".closing .editable-box");
    const titleEl = activeLetter.querySelector("#title");
    const bodyEl = activeLetter.querySelector(".body");
    
    const receiver = receiverEl ? receiverEl.textContent.trim() : "";
    ...
    const fontColorValue = bodyEl ? bodyEl.style.color || "" : "";
    ...
    // =========================
    const githubBaseUrl = "https://dwaineariel.github.io/multi-letter-app/view.html"; // your GitHub Pages view.html
    const viewLink = `${githubBaseUrl}?type=${encodeURIComponent(type)}&receiver=${encodeURIComponent(receiver)}&sender=${encodeURIComponent(sender)}&body=${encodeURIComponent(encodedBody)}&fontFamily=${encodeURIComponent(fontFamily)}&fontSize=${encodeURIComponent(fontSize)}&fontColor=${encodeURIComponent(fontColorValue)}`;
    ...
    const templateParams = {
      ...
      font_size: fontSize,
      font_color: fontColorValue,
      letter_color: letterColors[type],
      view_link: viewLink // <-- ensures correct letter
    };
