document.addEventListener("DOMContentLoaded", () => {
  ...
  // ===============================
  // ✅ FIXED SEND BUTTON — USE USER-TYPED CONTENT
  // ===============================
  sendBtn.onclick = () => {
    ...
    const activeLetter = letters[letterType.value];
    const letterContent = activeLetter.querySelector(".body").innerHTML; // FIX: get typed content
    const senderNameValue = activeLetter.querySelector("#senderName").textContent;
    const titleValue = activeLetter.querySelector("#title").textContent;
    const typeValue = letterType.value;
    ...
    // EmailJS template params — make sure names match template
    const templateParams = {
      recipient_email: email,
      letter_content: encodeURIComponent(letterContent), // ENCODE for URL
      letter_title: encodeURIComponent(titleValue),
      letter_type: typeValue,
