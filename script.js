document.addEventListener("DOMContentLoaded", () => {
  ...
  function switchLetter(type) {
    ...
    if (bodyEl) {
      bodyEl.style.fontFamily = fontSelect.value;
      bodyEl.style.color = fontColor.value;
      bodyEl.style.fontSize = fontSizeSlider.value + "px";
    }
  ...
  fontSelect.onchange = e => {
    const bodyEl = letters[letterType.value].querySelector(".body");
    if (bodyEl) bodyEl.style.fontFamily = e.target.value;
  };
  fontColor.oninput = e => {
    const bodyEl = letters[letterType.value].querySelector(".body");
    if (bodyEl) bodyEl.style.color = e.target.value;
  };
  fontSizeSlider.oninput = e => {
    const bodyEl = letters[letterType.value].querySelector(".body");
    if (bodyEl) bodyEl.style.fontSize = e.target.value + "px";
  };
  ...
  sendBtn.onclick = () => {
    ...
    const encodedBody = encodeContent(bodyHTML);
