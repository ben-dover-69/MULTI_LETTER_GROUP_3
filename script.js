document.addEventListener("DOMContentLoaded", () => {
  ...
  sendBtn.onclick = () => {
    ...
    // Get content (FIX: use innerText instead of innerHTML)
    const receiver = activeLetter.querySelector("#receiverName")?.innerText || "";
    const sender = activeLetter.querySelector("#senderName")?.innerText || "";
    const title = activeLetter.querySelector("#title")?.innerText || "";
    const bodyEl = activeLetter.querySelector(".body");
    const body = bodyEl ? bodyEl.innerText : ""; // <-- FIXED: capture exact user input
    ...
    // =========================
    // Generate full GitHub Pages link
    // =========================
    const githubBaseUrl = "https://dwaineariel.github.io/multi-letter-app/view.html"; // <-- your GitHub Pages link
