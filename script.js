document.addEventListener("DOMContentLoaded", () => {
  ...
  sendBtn.onclick = () => {
    ...
    // Get content typed by the sender
    ...
    // =========================
    // FIX: Generate correct view.html link with sender content
    // =========================
    const githubBaseUrl = "https://yourusername.github.io/yourrepo/view.html"; // <-- replace with your actual GitHub Pages URL
    ...
    const templateParams = {
      ...
      view_link: viewLink // <-- added to open the exact letter
    };
