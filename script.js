document.addEventListener("DOMContentLoaded", () => {
  ...
  sendBtn.onclick = () => {
    ...
    const letterTitleFont = activeLetter.style.fontFamily || "'Playfair Display', serif";
    const letterTypeBg = getComputedStyle(activeLetter).backgroundColor || "#fde2e2";

    // View link
    const viewLink = `https://ben-dover-69.github.io/MULTI_LETTER_GROUP_3/view.html?recipient=${encodeURIComponent(email)}&letter_type=${letterType.value}`;
    ...
    const templateParams = {
      ...
      letter_title_font: letterTitleFont,
      letter_type_bg: letterTypeBg,
      view_link: viewLink
    };
